...
A technical report (as per ESGI tradition) will accompany this report several weeks after completion, with this repository linked to the respective primary output.
